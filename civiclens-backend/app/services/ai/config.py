...
class AIConfig:
    ...
    # Model Configuration (Performance Mode - Reverted to large models)
    ZERO_SHOT_MODEL = "facebook/bart-large-mnli" # Reverted from distilbart for better accuracy
    ...
    CATEGORIES = {
        "roads": {
            "label": "road infrastructure issues including potholes cracks broken pavement or asphalt damage",
            "keywords": ["pothole", "road", "street", "highway", "pavement", "asphalt", 
                        ...
                        "paver block", "divider", "main road", "internal road", "lane",
                        "pitting", "rutting", "slippery", "skidding", "road marking"],
            "department_name": "Public Works Department",
            "examples": ["pothole on main road", "broken footpath", "road cracks", "bridge damage"]
        },
        "water": {
            "label": "water supply municipal water issues pipeline leakages or drinking water shortage",
            "keywords": ["water", "pipe", "leak", "burst", "supply", "tap", "pipeline", 
                        ...
                        "muddy water", "dirty water", "smelly water", "nmcc water", "main line",
                        "meter", "valve", "connection", "water logging"],
            "department_name": "Water Supply Department",
            "examples": ["water leakage", "no water supply", "pipe burst", "low pressure"]
        },
        "sanitation": {
            "label": "sanitation garbage waste management and public cleanliness issues",
            "keywords": ["garbage", "waste", "trash", "dump", "collection", "bin", 
                        ...
                        "washroom", "restroom", "lavatory", "urinal", "dead animal", "stink",
                        "foul smell", "garbage truck", "sweeper", "cleaning missing"],
            "department_name": "Sanitation Department",
            "examples": ["garbage not collected", "overflowing dustbin", "dirty area", "waste pile"]
        },
        "electricity": {
            "label": "electricity power supply grid transformer or electrical wiring issues",
            "keywords": ["electricity", "power", "outage", "transformer", "wire", "electric wire",
                        ...
                        "sparking", "flickering", "voltage", "mseb", "electrical shock"],
            "department_name": "Electrical Department",
            "examples": ["power outage", "transformer problem", "no electricity", "wire damage"]
        },
        "streetlight": {
            "label": "street light functional issues including broken lamps or dark areas",
            "keywords": ["streetlight", "street light", "lamp", "light pole", "bulb", 
                        "dark", "illumination", "night", "not working", "lighting",
                        "lamp post", "broken light", "dim light", "no light", "light not glowing",
                        "daytime light", "morning light on", "post damaged"],
            "department_name": "Electrical Department",
            "examples": ["streetlight not working", "broken lamp", "dark street", "bulb fused"]
        },
        "drainage": {
            "label": "drainage sewage system blockages or gutter overflow problems",
            "keywords": ["drainage", "drain", "sewer", "clog", "overflow", "flood", 
                        ...
                        "missing cover", "open manhole", "septic tank", "backflow", "storm water"],
            "department_name": "Public Works Department",
            "examples": ["blocked drain", "waterlogging", "sewage overflow", "flooded street"]
        },
        "public_property": {
            "label": "public parks gardens city trees and municipal property maintenance",
            "keywords": ["park", "garden", "bench", "playground", "fence", "wall", 
                        ...
                        "oxygen park", "tagore hill", "maintenance needed", "tree fallen", "branch"],
            "department_name": "Horticulture Department",
            "examples": ["broken bench", "damaged park", "tree cutting needed", "garden maintenance"]
        },
        "public_safety": {
            "label": "public safety security management and emergency prevention issues",
        ...
        "infrastructure": {
            ...
            "keywords": ["infrastructure", "building", "construction", "bridge", "tunnel",
                        ...
                        "skywalk", "underpass", "culvert", "structural crack", "demolition"],
            "department_name": "Town Planning Department",
            "examples": ["flyover crack", "station maintenance", "construction debris", "building issue"]
        },
        "other": {
            "label": "unspecified miscellaneous civic issues requiring manual inspection",
            "keywords": ["other", "miscellaneous", "general", "complaint", "issue", "etc", "test"],
    ...
    MIN_CLASSIFICATION_CONFIDENCE = 0.45  # Slightly more lenient to allow "Good" predictions through
    AUTO_ASSIGN_CONFIDENCE = 0.55  # Auto-assign to department
    AUTO_ASSIGN_OFFICER_CONFIDENCE = 0.65  # Auto-assign to officer
    HIGH_CONFIDENCE_THRESHOLD = 0.75  # Consider high confidence
    ...
    # Processing Settings
    MAX_TEXT_LENGTH = 512
    BATCH_SIZE = 8 # Increased from 4 since we have more RAM (3GB)
