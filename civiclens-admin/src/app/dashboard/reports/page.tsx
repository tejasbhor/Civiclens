...
import { ViewReportModal } from '@/components/reports/modals/ViewReportModal';
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-gray-900 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.total.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-yellow-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.needs_review.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-purple-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.assigned.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-blue-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.in_progress.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-green-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.resolved.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-red-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.critical.toLocaleString()}</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="text-xl font-bold text-orange-600 mt-2">{statsLoading ? <span className="animate-pulse">…</span> : stats.high.toLocaleString()}</div>
            </div>
