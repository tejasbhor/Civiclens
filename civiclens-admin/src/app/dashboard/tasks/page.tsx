                    ...
                    <div className="space-y-2">
                      {task.report?.address && (
                        <div className="flex items-center gap-2 text-xs text-gray-600">
                          ...
                          <span className="truncate">{task.report.address}</span>
                        </div>
                      )}
                      {task.officer && (
                        <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      {task.report?.department && (
                        <div className="flex items-center gap-2 text-xs text-gray-600">
                          ...
                          <span className="truncate">{task.report.department.name}</span>
                        </div>
                      )}
                      <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-600">
                        ...
                        {task.report?.address && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="truncate max-w-[200px]">{task.report.address}</span>
                          </div>
                        )}
                        <div className="flex items-center gap-1">
