      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Real-time AI pipeline performance and insights</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${activeTab === 'monitoring'
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${activeTab === 'actions'
              ? 'text-primary-600 border-b-2 border-primary-600 bg-primary-50'
              : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
              }`}
          >
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="text-xl font-bold text-blue-600">{pipelineStatus.queue_length}</div>
                ...
                <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <div className="text-xl font-bold text-red-600">{pipelineStatus.failed_queue_length}</div>
                ...
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <div className="text-xl font-bold text-purple-600">{pipelineStatus.reports_in_queue.length}</div>
                  ...
                  <div className="space-y-2">
                    {pipelineStatus.reports_in_queue.slice(0, 5).map((report) => (
                      <div key={report.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <Badge className="bg-blue-100 text-blue-800 border-blue-200" size="sm">{report.status}</Badge>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-gray-900">{metrics.total_processed.toLocaleString()}</p>
                    </div>
                  </div>
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className={`text-xl font-bold ${getConfidenceColor(metrics.avg_confidence)}`}>
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-yellow-600">{metrics.needs_review_count}</p>
                    </div>
                  </div>
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-purple-600">{metrics.duplicate_detection_count}</p>
                    </div>
                  </div>
                  <p className="text-xs text-gray-500 mt-3">
                    ...
                    {categoryInsights.map((insight) => (
                      <tr key={insight.category} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="text-center py-3 px-4">
                          <Badge className="bg-blue-100 text-blue-800 border-blue-200" size="sm">{insight.ai_classified}</Badge>
                        </td>
                        <td className="text-center py-3 px-4">
                          <Badge className="bg-green-100 text-green-800 border-green-200" size="sm">{insight.manual_classified}</Badge>
                        </td>
                        <td className="text-center py-3 px-4">
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="text-xl font-bold text-blue-600">{pendingReports.length}</div>
                </div>
                <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                  <div className="text-sm text-green-700 mb-1">Selected</div>
                  <div className="text-xl font-bold text-green-600">{selectedReports.size}</div>
                </div>
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <div className="divide-y divide-gray-200">
                  {pendingReports.map((report) => {
                    ...
                    return (
                      <div
                        key={report.id}
                        className={`p-4 transition-colors ${isQueued ? 'bg-blue-50 border-l-4 border-blue-500' :
              ...
              <div className="p-6 overflow-y-auto max-h-[60vh]">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 rounded-lg p-4 text-center">
                    <div className="text-xl font-bold text-gray-900">{progressModal.total}</div>
                    <div className="text-sm text-gray-600">Total Selected</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-4 text-center">
                    <div className="text-xl font-bold text-green-600">{progressModal.queued}</div>
                    <div className="text-sm text-gray-600">Queued for AI</div>
                  </div>
                  <div className="bg-yellow-50 rounded-lg p-4 text-center">
                    <div className="text-xl font-bold text-yellow-600">{progressModal.skipped}</div>
